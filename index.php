		...
		<div class="container">
			...
			<div class="row about-text">
				<div class="col-md-10 m-auto">
					...
					<p>After about a year of intense learning I found my first job as frontend developer. I was creating websites in: HTML, CSS (Sass), JavaScript (mostly jQuery), Bootstrap, and I set up these websites on WordPress.</p>
					<p>After a while I decided that I would like to participate in bigger projects and focus mostly on JavaScript and learn React with Redux. I quit my previous job and from June I focused on self-study of JS, React + Redux, and now I'm working in Accenture.</p>
